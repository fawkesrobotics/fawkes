...
color_t
ColorModelThresholds::determine(unsigned int y, unsigned int u, unsigned int v) const
{
	if (y >= THRESHOLD_WHITE_Y_LOW) {
		return C_WHITE;
	}
	if (u <= THRESHOLD_GREEN_U_HIGH && v <= THRESHOLD_GREEN_V_HIGH) {
		return C_GREEN;
	} else if (/*THRESHOLD_ORANGE_U_LOW <= u &&*/
	           u <= THRESHOLD_ORANGE_U_HIGH && v >= THRESHOLD_ORANGE_V_LOW) {
		return C_ORANGE;
...
ColorModelThresholds::print_thresholds()
{
	cout << "ColorModelThresholds" << endl
	     << "==========================================================" << endl
	     << "Orange:  u_low=" << THRESHOLD_ORANGE_U_LOW << "  u_high=" << THRESHOLD_ORANGE_U_HIGH
	     << " v_low=" << THRESHOLD_ORANGE_V_LOW << endl
	     << "Yellow:  u_high=" << THRESHOLD_YELLOW_U_HIGH << " v_low=" << THRESHOLD_YELLOW_V_LOW
	     << endl;
}
