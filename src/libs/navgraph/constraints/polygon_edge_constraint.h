...
#ifndef _NAVGRAPH_CONSTRAINTS_POLYGON_EDGE_CONSTRAINT_H_
#define _NAVGRAPH_CONSTRAINTS_POLYGON_EDGE_CONSTRAINT_H_
...
class NavGraphPolygonEdgeConstraint : public NavGraphEdgeConstraint,
