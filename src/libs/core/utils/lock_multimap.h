...
#ifndef _CORE_UTILS_LOCK_MULTIMAP_H_
#define _CORE_UTILS_LOCK_MULTIMAP_H_
...
LockMultiMap<KeyType, ValueType, LessKey>::LockMultiMap() : mutex_(new Mutex())
{
}
...
: std::map<KeyType, ValueType, LessKey>::map(lm), mutex_(new Mutex())
{
}
