 ...
 */
WebPageReply::WebPageReply(Code code) : StaticWebReply(code)
{
	navbar_enabled_ = true;
	footer_enabled_ = true;
                   ...
                   WebPageFooterGenerator *footergen)
{
	...
	if (footergen && footer_enabled_)
		merged_body_ += footergen->html_footer();
	else
		merged_body_ += PAGE_FOOTER;
}
 ...
 */
void
WebPageReply::set_navbar_enabled(bool enabled)
{
 ...
 */
bool
WebPageReply::get_navbar_enabled()
{
 ...
 */
void
WebPageReply::set_footer_enabled(bool enabled)
{
 ...
 */
bool
WebPageReply::get_footer_enabled()
{
