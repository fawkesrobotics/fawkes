 ...
 */
ShmCouldNotAttachException::ShmCouldNotAttachException(const char *msg) : Exception(msg)
{
}
 ...
 */
/** Constructor. */
ShmNoHeaderException::ShmNoHeaderException() : Exception("No SharedMemoryHeader, cannot attach")
{
}
