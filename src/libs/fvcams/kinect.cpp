 ...
 */
FvFreenectDevice::FvFreenectDevice(freenect_context *ctx, int index) : FreenectDevice(ctx, index)
{
...
KinectCamera::set_image_number(unsigned int n)
{
	...
	default: m_buffer = m_freenect_dev->rgb_buffer();
	}
}
