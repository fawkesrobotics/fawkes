...
class QaBBEventListener : public BlackBoardInterfaceListener, public BlackBoardInterfaceObserver
{
public:
	QaBBEventListener(BlackBoard *bb) : BlackBoardInterfaceListener("QaBBEventListener"), bb_(bb)
	{
...
main(int argc, char **argv)
{
	...
	TestInterface::SetTestStringMessage *m2 = new TestInterface::SetTestStringMessage("Foo");
