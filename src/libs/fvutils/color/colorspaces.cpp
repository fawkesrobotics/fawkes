...
colorspace_to_string(colorspace_t colorspace)
{
	switch (colorspace) {
	case RGB: return "RGB";
	case YUV411_PACKED: return "YUV411_PACKED";
	case YUV411_PLANAR: return "YUV411_PLANAR";
	case YUV420_PLANAR: return "YUV420_PLANAR";
	case YUY2: return "YUY2";
	case YVY2: return "YVY2";
	case BGR: return "BGR";
	case YUV422_PACKED: return "YUV422_PACKED";
	case YUV444_PACKED: return "YUV444_PACKED";
	case YVU444_PACKED: return "YVU444_PACKED";
	case YUV422_PLANAR: return "YUV422_PLANAR";
	case YUV422_PLANAR_QUARTER: return "YUV422_PLANAR_QUARTER";
	case GRAY8: return "GRAY8";
	case MONO8: return "MONO8";
	case RGB_WITH_ALPHA: return "RGB_WITH_ALPHA";
	case BGR_WITH_ALPHA: return "BGR_WITH_ALPHA";
	case BAYER_MOSAIC_RGGB: return "BAYER_MOSAIC_RGGB";
	case BAYER_MOSAIC_GBRG: return "BAYER_MOSAIC_GBRG";
	case BAYER_MOSAIC_GRBG: return "BAYER_MOSAIC_GRBG";
	case BAYER_MOSAIC_BGGR: return "BAYER_MOSAIC_BGGR";
	case RAW16: return "RAW16";
	case CARTESIAN_3D_FLOAT: return "CARTESIAN_3D_FLOAT";
...
colorspace_buffer_size(colorspace_t cspace, unsigned int width, unsigned int height)
{
	...
	case RGB_PLANAR:
	case YUV444_PACKED:
	case YVU444_PACKED: return (width * height * 3);

	case RGB_WITH_ALPHA:
	case BGR_WITH_ALPHA: return (width * height * 4);

	case YUV411_PACKED:
	case YUV411_PLANAR:
	case YUV420_PLANAR: return (width * height * 3 / 2);

	case YUY2:
	case YVY2:
	case YUV422_PACKED:
	case YUV422_PLANAR: return (width * height * 2);

	case MONO16:
	case RAW16: return (width * height * 2);
	...
	case BAYER_MOSAIC_BGGR: return (width * height);

	case YUV422_PLANAR_QUARTER: return (width * height) / 2;

	case CARTESIAN_3D_FLOAT: return (3 * (size_t)width * height * sizeof(float));
