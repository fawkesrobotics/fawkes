...
main(int argc, char **argv)
{
	...
	RectificationLutInfoBlock *rlib =
	  new RectificationLutInfoBlock(WIDTH, HEIGHT, FIREVISION_RECTINFO_CAMERA_MAIN);

	RectificationLutInfoBlock *rlib2 =
	  new RectificationLutInfoBlock(WIDTH, HEIGHT, FIREVISION_RECTINFO_CAMERA_LEFT);
  ...
  */
	...
	for (RectificationInfoFile::RectInfoBlockVector::iterator i = blocks->begin(); i != blocks->end();
	     ++i) {
