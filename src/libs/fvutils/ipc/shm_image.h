...
class SharedMemoryImageBufferHeader : public fawkes::SharedMemoryHeader
{
public:
...
class SharedMemoryImageBufferLister : public fawkes::SharedMemoryLister
{
public:
...
class SharedMemoryImageBufferMetaDataCollector : public fawkes::SharedMemoryLister
{
public:
