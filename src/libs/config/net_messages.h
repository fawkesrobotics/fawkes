...
#define MSG_CONFIG_SET_END       MSG_CONFIG_SET_STRING
#define MSG_CONFIG_ERASE_VALUE   15

#define MSG_CONFIG_GET_TAGS      20
#define MSG_CONFIG_LOAD_TAG      21
#define MSG_CONFIG_SAVE_TAG      22
#define MSG_CONFIG_INV_TAG       23
#define MSG_CONFIG_DEL_TAG       24
