...
#ifndef _INTERFACES_GENERATOR_EXCEPTIONS_H_
#define _INTERFACES_GENERATOR_EXCEPTIONS_H_
...
public:
   ...
   */
	InterfaceGeneratorInvalidDocumentException(const char *format, ...) : fawkes::Exception()
	{
		va_list arg;
		va_start(arg, format);
...
public:
   ...
   * arguments. Cf. printf man page for valid format.
   */
	InterfaceGeneratorInvalidContentException(const char *format, ...) : fawkes::Exception()
	{
		va_list arg;
		va_start(arg, format);
		append_va(format, arg);
...
public:
   ...
   */
	InterfaceGeneratorInvalidFlagException(const char *name, const char *flag) : fawkes::Exception()
	{
...
public:
   ...
   * @param item item type
   */
	InterfaceGeneratorAmbiguousNameException(const char *name, const char *item) : fawkes::Exception()
	{
