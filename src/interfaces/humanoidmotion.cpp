...
/***************************************************************************
 *  humanoidmotion.cpp - Fawkes BlackBoard Interface - HumanoidMotionInterface
 *
...
/** @class HumanoidMotionInterface <interfaces/humanoidmotion.h>
...
HumanoidMotionInterface::HumanoidMotionInterface() : Interface()
{
  ...
  add_fieldinfo(Interface::IFT_BOOL, "moving", &data->moving);
  add_fieldinfo(Interface::IFT_FLOAT, "max_step_length", &data->max_step_length);
  add_fieldinfo(Interface::IFT_FLOAT, "max_step_height", &data->max_step_height);
  add_fieldinfo(Interface::IFT_FLOAT, "max_step_side", &data->max_step_side);
  add_fieldinfo(Interface::IFT_FLOAT, "max_step_turn", &data->max_step_turn);
  add_fieldinfo(Interface::IFT_FLOAT, "zmp_offset_forward", &data->zmp_offset_forward);
  add_fieldinfo(Interface::IFT_FLOAT, "zmp_offset_sideward", &data->zmp_offset_sideward);
  add_fieldinfo(Interface::IFT_FLOAT, "l_hip_roll_compensation", &data->l_hip_roll_compensation);
  add_fieldinfo(Interface::IFT_FLOAT, "r_hip_roll_compensation", &data->r_hip_roll_compensation);
  add_fieldinfo(Interface::IFT_FLOAT, "hip_height", &data->hip_height);
  add_fieldinfo(Interface::IFT_FLOAT, "torso_sideward_orientation", &data->torso_sideward_orientation);
...
/* =========== messages =========== */
/** @class HumanoidMotionInterface::SetWalkParamsMessage interfaces/humanoidmotion.h
...
/** @class HumanoidMotionInterface::SetWalkArmsParamsMessage interfaces/humanoidmotion.h
...
/** @class HumanoidMotionInterface::StopMessage interfaces/humanoidmotion.h
...
/** @class HumanoidMotionInterface::WalkStraightMessage interfaces/humanoidmotion.h
...
/** @class HumanoidMotionInterface::WalkSidewaysMessage interfaces/humanoidmotion.h
...
/** @class HumanoidMotionInterface::WalkArcMessage interfaces/humanoidmotion.h
...
/** @class HumanoidMotionInterface::TurnMessage interfaces/humanoidmotion.h
...
/** @class HumanoidMotionInterface::KickMessage interfaces/humanoidmotion.h
...
/** @class HumanoidMotionInterface::ParkMessage interfaces/humanoidmotion.h
...
/** @class HumanoidMotionInterface::GetUpMessage interfaces/humanoidmotion.h
