...
MotorInterface::MotorInterface() : Interface()
{
  ...
  add_fieldinfo(Interface::IFT_UINT, "motor_state", 1, &data->motor_state);
  add_fieldinfo(Interface::IFT_UINT, "drive_mode", 1, &data->drive_mode);
  add_fieldinfo(Interface::IFT_INT, "right_rpm", 1, &data->right_rpm);
  add_fieldinfo(Interface::IFT_INT, "rear_rpm", 1, &data->rear_rpm);
  add_fieldinfo(Interface::IFT_INT, "left_rpm", 1, &data->left_rpm);
  add_fieldinfo(Interface::IFT_FLOAT, "odometry_path_length", 1, &data->odometry_path_length);
  add_fieldinfo(Interface::IFT_FLOAT, "odometry_position_x", 1, &data->odometry_position_x);
  add_fieldinfo(Interface::IFT_FLOAT, "odometry_position_y", 1, &data->odometry_position_y);
  add_fieldinfo(Interface::IFT_FLOAT, "odometry_orientation", 1, &data->odometry_orientation);
  add_fieldinfo(Interface::IFT_FLOAT, "vx", 1, &data->vx);
  add_fieldinfo(Interface::IFT_FLOAT, "vy", 1, &data->vy);
  add_fieldinfo(Interface::IFT_FLOAT, "omega", 1, &data->omega);
  add_fieldinfo(Interface::IFT_UINT, "controller", 1, &data->controller);
  add_fieldinfo(Interface::IFT_STRING, "controller_thread_name", 64, data->controller_thread_name);
