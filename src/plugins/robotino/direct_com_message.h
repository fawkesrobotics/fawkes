...
#ifndef _PLUGINS_ROBOTINO_DIRECT_COM_MESSAGE_H_
#define _PLUGINS_ROBOTINO_DIRECT_COM_MESSAGE_H_
...
public:
	...
	typedef enum { READ, WRITE } mode_t;
	...
	{
	public:
		ChecksumError(unsigned int  expected,
