...
#ifndef _PLUGINS_ROBOTINO_DIRECT_COM_THREAD_H_
#define _PLUGINS_ROBOTINO_DIRECT_COM_THREAD_H_
...
class DirectRobotinoComThread : public RobotinoComThread, public fawkes::ConfigurableAspect
{
public:
...
private:
	...
	DirectRobotinoComMessage::pointer send_and_recv(DirectRobotinoComMessage &msg);
