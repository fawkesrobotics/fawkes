...
#ifndef _PLUGINS_PERCEPTION_PCL_DB_PCL_DB_RETRIEVE_PIPELINE_H_
#define _PLUGINS_PERCEPTION_PCL_DB_PCL_DB_RETRIEVE_PIPELINE_H_
...
private: //methods
	void
	copy_output(pcl::PointCloud<pcl::PointXYZRGB>::Ptr &in,
