...
#ifndef _PLUGINS_PERCEPTION_TABLETOP_OBJECTS_THREAD_H_
#define _PLUGINS_PERCEPTION_TABLETOP_OBJECTS_THREAD_H_
...
public:
   ...
   * @return reference to this instance */
	OldCentroid &
	operator=(const OldCentroid &other)
	{
		id_       = other.get_id();
		age_      = other.get_age();
...
class TabletopObjectsThread : public fawkes::Thread,
...
private:
	...
	bool     is_polygon_edge_better(PointType &cb_br_p1p,
	                                PointType &cb_br_p2p,
	                                PointType &br_p1p,
	                                PointType &br_p2p);
	...
	unsigned int cluster_objects(CloudConstPtr               input,
