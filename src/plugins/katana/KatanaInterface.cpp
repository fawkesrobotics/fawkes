...
KatanaInterface::KatanaInterface() : Interface()
{
  ...
  add_fieldinfo(Interface::IFT_BYTE, "sensor_value", 16, &data->sensor_value);
  add_fieldinfo(Interface::IFT_FLOAT, "x", 1, &data->x);
  add_fieldinfo(Interface::IFT_FLOAT, "y", 1, &data->y);
  add_fieldinfo(Interface::IFT_FLOAT, "z", 1, &data->z);
  add_fieldinfo(Interface::IFT_FLOAT, "phi", 1, &data->phi);
  add_fieldinfo(Interface::IFT_FLOAT, "theta", 1, &data->theta);
  add_fieldinfo(Interface::IFT_FLOAT, "psi", 1, &data->psi);
