...
#ifndef _PLUGINS_LASER_SICK_TIM55X_ETHERNET_AQT_H_
#define _PLUGINS_LASER_SICK_TIM55X_ETHERNET_AQT_H_
...
private:
	...
	void
	handle_read(boost::system::error_code ec, size_t bytes_read)
	{
		ec_         = ec;
