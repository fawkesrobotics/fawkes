...
public:
   ...
   */
	 ...
	 */
	void
	set_services(const std::vector<std::shared_ptr<Service>> &services)
	{
		services_ = services;
	}
	 ...
	 */
	void
	addto_services(const std::shared_ptr<Service> &&services)
	{
	 ...
	 */
	void
	addto_services(const Service &&services)
	{
