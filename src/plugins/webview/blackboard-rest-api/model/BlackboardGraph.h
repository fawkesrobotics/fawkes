...
public:
	 ...
	 */
	BlackboardGraph(const std::string &json);
	/** Constructor from JSON.
...
public:
   ...
   */
	...
	/** Set dotgraph value.
	 * @param dotgraph new value
	 */
	void
	set_dotgraph(const std::string &dotgraph)
	{
		dotgraph_ = dotgraph;
	}
...
private:
	...
	std::optional<std::string> dotgraph_;
};