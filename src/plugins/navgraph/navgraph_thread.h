...
#ifndef _PLUGINS_NAVGRAPH_NAVGRAPH_THREAD_H_
#define _PLUGINS_NAVGRAPH_NAVGRAPH_THREAD_H_
...
class NavGraphThread : public fawkes::Thread,
...
private:
	...
	bool   replan(const fawkes::NavGraphNode &start, const fawkes::NavGraphNode &goal);
	void   optimize_plan();
	void   stop_motion();
	void   start_plan();
	void   send_next_goal();
