(deffacts blocksworld
  ...
  (domain-atomic-precondition
    (part-of neg-on-table) (params (create$ x)) (predicate ontable))
  (domain-atomic-precondition
    (part-of pick-up-precond) (params (create$ x)) (predicate clear))
  (domain-atomic-precondition
  ...
  (domain-atomic-precondition
    (part-of unstack-precond) (params (create$ x y)) (predicate on))
  (domain-atomic-precondition
    (part-of unstack-precond) (params (create$ x)) (predicate clear))
  (domain-atomic-precondition
