...
" Load all initial domain facts on startup of the game "
  ...
  (assert
    ...
    (domain-fact (name location-is-part-of-machine) (param-values MACHINE1-INPUT MACHINE1))
    (domain-fact (name location-is-part-of-machine) (param-values MACHINE1-OUTPUT MACHINE1))
    (domain-fact (name location-is-part-of-machine) (param-values MACHINE2-INPUT MACHINE2))
    (domain-fact (name location-is-part-of-machine) (param-values MACHINE2-OUTPUT MACHINE2))
  )
