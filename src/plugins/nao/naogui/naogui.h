...
#ifndef _PLUGINS_NAO_TOOLS_NAOGUI_NAOGUI_H_
#define _PLUGINS_NAO_TOOLS_NAOGUI_NAOGUI_H_
...
private:
	...
	bool on_led_slider_button_release(GdkEventButton *event, std::string iface_id, Gtk::Scale *scl);
