...
enum LedType {
	LED_CHESTBOARD_RED,
	LED_CHESTBOARD_GREEN,
	LED_CHESTBOARD_BLUE,
	LED_EARS_LEFT_0DEG,
	LED_EARS_LEFT_36DEG,
	LED_EARS_LEFT_72DEG,
	LED_EARS_LEFT_108DEG,
	LED_EARS_LEFT_144DEG,
	LED_EARS_LEFT_180DEG,
	LED_EARS_LEFT_216DEG,
	LED_EARS_LEFT_252DEG,
	LED_EARS_LEFT_288DEG,
	LED_EARS_LEFT_324DEG,
	LED_EARS_RIGHT_0DEG,
	LED_EARS_RIGHT_36DEG,
	LED_EARS_RIGHT_72DEG,
	LED_EARS_RIGHT_108DEG,
	LED_EARS_RIGHT_144DEG,
	LED_EARS_RIGHT_180DEG,
	LED_EARS_RIGHT_216DEG,
	LED_EARS_RIGHT_252DEG,
	LED_EARS_RIGHT_288DEG,
	LED_EARS_RIGHT_324DEG,
	LED_FACE_LEFT_RED_0DEG,
	LED_FACE_LEFT_RED_45DEG,
	LED_FACE_LEFT_RED_90DEG,
	LED_FACE_LEFT_RED_135DEG,
	LED_FACE_LEFT_RED_180DEG,
	LED_FACE_LEFT_RED_225DEG,
	LED_FACE_LEFT_RED_270DEG,
	LED_FACE_LEFT_RED_315DEG,
	LED_FACE_LEFT_GREEN_0DEG,
	LED_FACE_LEFT_GREEN_45DEG,
	LED_FACE_LEFT_GREEN_90DEG,
	LED_FACE_LEFT_GREEN_135DEG,
	LED_FACE_LEFT_GREEN_180DEG,
	LED_FACE_LEFT_GREEN_225DEG,
	LED_FACE_LEFT_GREEN_270DEG,
	LED_FACE_LEFT_GREEN_315DEG,
	LED_FACE_LEFT_BLUE_0DEG,
	LED_FACE_LEFT_BLUE_45DEG,
	LED_FACE_LEFT_BLUE_90DEG,
	LED_FACE_LEFT_BLUE_135DEG,
	LED_FACE_LEFT_BLUE_180DEG,
	LED_FACE_LEFT_BLUE_225DEG,
	LED_FACE_LEFT_BLUE_270DEG,
	LED_FACE_LEFT_BLUE_315DEG,
	LED_FACE_RIGHT_RED_0DEG,
	LED_FACE_RIGHT_RED_45DEG,
	LED_FACE_RIGHT_RED_90DEG,
	LED_FACE_RIGHT_RED_135DEG,
	LED_FACE_RIGHT_RED_180DEG,
	LED_FACE_RIGHT_RED_225DEG,
	LED_FACE_RIGHT_RED_270DEG,
	LED_FACE_RIGHT_RED_315DEG,
	LED_FACE_RIGHT_GREEN_0DEG,
	LED_FACE_RIGHT_GREEN_45DEG,
	LED_FACE_RIGHT_GREEN_90DEG,
	LED_FACE_RIGHT_GREEN_135DEG,
	LED_FACE_RIGHT_GREEN_180DEG,
	LED_FACE_RIGHT_GREEN_225DEG,
	LED_FACE_RIGHT_GREEN_270DEG,
	LED_FACE_RIGHT_GREEN_315DEG,
	LED_FACE_RIGHT_BLUE_0DEG,
	LED_FACE_RIGHT_BLUE_45DEG,
	LED_FACE_RIGHT_BLUE_90DEG,
	LED_FACE_RIGHT_BLUE_135DEG,
	LED_FACE_RIGHT_BLUE_180DEG,
	LED_FACE_RIGHT_BLUE_225DEG,
	LED_FACE_RIGHT_BLUE_270DEG,
	LED_FACE_RIGHT_BLUE_315DEG,
	LED_LFOOT_RED,
	LED_LFOOT_GREEN,
	LED_LFOOT_BLUE,
	LED_RFOOT_RED,
...
NaoQiLedThread::init()
{
	...
	for (l = leddevs.begin(); l != leddevs.end(); ++l) {
		...
		try {
			LedInterface *iface = blackboard->open_for_writing<LedInterface>(id.c_str());
		...
		for (unsigned int lr = 0; lr < 2; ++lr) {
			for (unsigned int cl = 0; cl < 3; ++cl) {
				...
				for (unsigned int a = 0; a < 8; ++a) {
					...
					std::string memid = subd_prefix_ + entry + "/" + angles[a] + "Deg/Actuator/Value";
	...
	for (LedMap::iterator i = leds_.begin(); i != leds_.end(); ++i) {
		...
		std::pair<LedMap::iterator, LedMap::iterator> ret = leds_.equal_range(i->first);
...
NaoQiLedThread::loop()
{
	...
	for (LedMap::iterator i = leds_.begin(); i != leds_.end(); ++i) {
		...
		std::pair<LedMemMap::iterator, LedMemMap::iterator> ret = memids_.equal_range(i->first);
		for (LedMemMap::iterator j = ret.first; j != ret.second; ++j) {
			if (values_[j->second] > maxval)
				maxval = values_[j->second];
		}
...
NaoQiLedThread::bb_interface_message_received(Interface *interface, Message *message) throw()
{
	...
	std::pair<LedMap::iterator, LedMap::iterator> ret = leds_.equal_range(led_if);

	if (sim != NULL) {
		for (LedMap::iterator i = ret.first; i != ret.second; ++i) {
			printf("Set %s to %f\n", i->second.c_str(), sim->intensity());
			dcm::set_value(
			  dcm_, i->second, kind, sim->intensity(), (int)roundf(dcm_time + sim->time_sec() * 1000.));
		}
