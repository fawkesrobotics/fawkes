...
NaoQiMotionKickTask::run()
{
	...
	names         = ALValue::array(support_hip_roll_name,
                         shoot_hip_roll_name,
                         support_ankle_roll_name,
                         shoot_ankle_roll_name);
	target_angles = ALValue::array(deg2rad(support_hip_roll),
	                               deg2rad(shoot_hip_roll),
	                               deg2rad(support_ankle_roll),
	                               deg2rad(shoot_ankle_roll));
	speed         = 0.15;
	...
	target_angles =
	  ALValue::array(deg2rad(shoot_hip_roll), deg2rad(shoot_knee_pitch), deg2rad(shoot_ankle_pitch));
	speed = 0.2;
	...
	names         = ALValue::array(shoot_hip_pitch_name,
                         support_hip_pitch_name,
                         shoot_knee_pitch_name,
                         shoot_ankle_pitch_name);
	target_angles = ALValue::array(deg2rad(shoot_hip_pitch),
