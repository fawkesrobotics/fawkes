...
/** Constructor. */
ROS2TF2OThread::ROS2TF2OThread()
: Thread("ROS2TF2OThread", Thread::OPMODE_WAITFORWAKEUP),
  BlockedTimingAspect(BlockedTimingAspect::WAKEUP_HOOK_SENSOR_ACQUIRE),
  TransformAspect(TransformAspect::DEFER_PUBLISHER),
  BlackBoardInterfaceListener("ROS2TF2OThread")
{
...
void
ROS2TF2OThread::bb_interface_created(const char *type, const char *id) throw()
{
...
void
ROS2TF2OThread::bb_interface_writer_removed(fawkes::Interface *interface,
...
void
ROS2TF2OThread::bb_interface_reader_removed(fawkes::Interface *interface,
                                           fawkes::Uuid       instance_serial) noexcept
{
	conditional_close(interface);
}
...
void
ROS2TF2OThread::conditional_close(Interface *interface) noexcept
{
