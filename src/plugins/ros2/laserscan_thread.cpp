...
ROS2LaserScanThread::init()
{
	...
	auto callback = [this](sensor_msgs::msg::LaserScan::ConstSharedPtr msg,
	...
	sub_ls_ =
	  node_handle->create_subscription<sensor_msgs::msg::LaserScan>("scan", qos, callback, options);
...
void
ROS2LaserScanThread::bb_interface_data_refreshed(fawkes::Interface *interface) noexcept
{
...
void
ROS2LaserScanThread::bb_interface_created(const char *type, const char *id) noexcept
{
...
void
ROS2LaserScanThread::conditional_close(Interface *interface) noexcept
{
 ...
 */
void
ROS2LaserScanThread::laser_scan_message_cb(std::shared_ptr<const sensor_msgs::msg::LaserScan> msg,
