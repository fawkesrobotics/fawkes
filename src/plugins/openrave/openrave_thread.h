...
#ifndef _PLUGINS_OPENRAVE_OPENRAVE_THREAD_H_
#define _PLUGINS_OPENRAVE_OPENRAVE_THREAD_H_
...
class OpenRaveThread : public fawkes::Thread,
...
public:
	...
	virtual fawkes::OpenRaveRobotPtr       add_robot(const std::string &filename_robot,
