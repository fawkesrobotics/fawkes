 ...
 * @param calibrate decides whether to calculate offset (true )or set them directly (false; default)
 */
	virtual void set_manipulator(OpenRaveManipulatorPtr &manip,
	                             float                   trans_x   = 0.f,
	                             float                   trans_y   = 0.f,
	                             float                   trans_z   = 0.f,
	                             bool                    calibrate = 0) = 0;
  ...
  */
	virtual bool
	move_object(const std::string &name, float trans_x, float trans_y, float trans_z) = 0;
  ...
  * @return true if successful
  */
	virtual bool rotate_object(const std::string &name,
	                           float              quat_x,
	                           float              quat_y,
	                           float              quat_z,
	                           float              quat_w) = 0;
  ...
  */
	virtual bool
	set_target_object(const std::string &name, OpenRaveRobotPtr &robot, float rot_x = 0) = 0;
};
