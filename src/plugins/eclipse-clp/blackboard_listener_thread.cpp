 ...
 */
void
BlackboardListenerThread::observe_pattern(const char *type_pattern, const char *id_pattern) noexcept
{
...
void
BlackboardListenerThread::listen_for_change(Interface *interface) noexcept
{
	MutexLocker lock(&state_mutex_);
 ...
 */
void
BlackboardListenerThread::bb_interface_created(const char *type, const char *id) noexcept
{
	MutexLocker lock(&state_mutex_);
 ...
 */
void
BlackboardListenerThread::bb_interface_destroyed(const char *type, const char *id) noexcept
{
	MutexLocker lock(&state_mutex_);
 ...
 */
void
BlackboardListenerThread::bb_interface_data_changed(Interface *interface) noexcept
{
	MutexLocker lock(&state_mutex_);
 ...
 */
shared_ptr<BlackboardListenerThread::Event>
