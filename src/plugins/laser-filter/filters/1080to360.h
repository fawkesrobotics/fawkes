...
#ifndef _PLUGINS_LASER_FILTER_FILTERS_1080TO360_H_
#define _PLUGINS_LASER_FILTER_FILTERS_1080TO360_H_
...
{
 public:
	Laser1080to360DataFilter(const std::string& filter_name,
