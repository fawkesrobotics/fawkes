...
PanTiltInterface::PanTiltInterface() : Interface()
{
  ...
  add_fieldinfo(Interface::IFT_FLOAT, "pan", 1, &data->pan);
  add_fieldinfo(Interface::IFT_FLOAT, "tilt", 1, &data->tilt);
  ...
  add_fieldinfo(Interface::IFT_FLOAT, "min_pan", 1, &data->min_pan);
  add_fieldinfo(Interface::IFT_FLOAT, "max_pan", 1, &data->max_pan);
  add_fieldinfo(Interface::IFT_FLOAT, "min_tilt", 1, &data->min_tilt);
  add_fieldinfo(Interface::IFT_FLOAT, "max_tilt", 1, &data->max_tilt);
  add_fieldinfo(Interface::IFT_FLOAT, "max_pan_velocity", 1, &data->max_pan_velocity);
