...
const float         RobotisRX28::MAX_ANGLE_RAD            = fawkes::deg2rad(RobotisRX28::MAX_ANGLE_DEG); /**< MAX_ANGLE_RAD */
const float         RobotisRX28::RAD_PER_POS_TICK         = RobotisRX28::MAX_ANGLE_RAD / (float)(RobotisRX28::MAX_POSITION); /**< RAD_PER_POS_TICK */
const float         RobotisRX28::POS_TICKS_PER_RAD        = (float)(RobotisRX28::MAX_POSITION) / RobotisRX28::MAX_ANGLE_RAD; /**< POS_TICKS_PER_RAD */
 ...
 */
unsigned char
RobotisRX28::calc_checksum(const unsigned char id, const unsigned char instruction,
 ...
 */
void
RobotisRX28::send(const unsigned char id, const unsigned char instruction,
		  const unsigned char *params, const unsigned char plength)
{
...
RobotisRX28::finish_read_table_values()
{
  ...
  if (ibuffer_length_ != 5 + RX28_CONTROL_TABLE_LENGTH + 1) {
    throw Exception("Input buffer of invalid size: %u vs. %u", ibuffer_length_, 5 + RX28_CONTROL_TABLE_LENGTH + 1);
  }
  memcpy(control_table_[ibuffer_[PACKET_OFFSET_ID]],
	 &ibuffer_[PACKET_OFFSET_PARAM], RX28_CONTROL_TABLE_LENGTH);
}
 ...
 */
void
RobotisRX28::read_table_value(unsigned char id,
 ...
 */
void
RobotisRX28::write_table_value(unsigned char id, unsigned char addr,
 ...
 */
void
RobotisRX28::write_table_values(unsigned char id, unsigned char start_addr,
 ...
 */
unsigned int
RobotisRX28::merge_twobyte_value(unsigned int id,
 ...
 */
unsigned int
RobotisRX28::get_value(unsigned int id, bool refresh,
 ...
 */
void
RobotisRX28::set_angle_limits(unsigned char id,
			      unsigned int cw_limit, unsigned int ccw_limit)
{
