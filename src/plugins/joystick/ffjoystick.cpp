 ...
 * @author Tim Niemueller
 */
class JoystickBlackBoardLogger : public BlackBoardInterfaceListener, public SignalHandler
{
public:
	/** Constructor.
   ...
   */
	...
	: BlackBoardInterfaceListener("JoystickBlackBoardLogger"), logger_(logger)
	{
		...
		joystick_if_->read();
		logger->log_debug("Joystick", "Number of Axes:    %i", joystick_if_->num_axes());
		logger->log_debug("Joystick", "Number of Buttons: %i", joystick_if_->num_buttons());
 ...
 * @author Tim Niemueller
 */
class JoystickBlackBoardActListener : public BlackBoardInterfaceListener
{
public:
	/** Constructor.
...
main(int argc, char **argv)
{
	try {
		...
		if (argp.has_arg("l")) {
			...
			JoystickBlackBoardActListener  aml(&aqt, jbp.blackboard(), jbp.joystick_if(), &logger);
