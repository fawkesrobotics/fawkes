...
#ifndef _PLUGINS_OPENPRS_AGENT_OPENPRS_AGENT_THREAD_H_
#define _PLUGINS_OPENPRS_AGENT_OPENPRS_AGENT_THREAD_H_
...
class OpenPRSAgentThread : public fawkes::Thread,
