...
/***************************************************************************
 *  pf_vector.c: Vector functions
 *
 *  Created: Thu May 24 18:42:09 2012
...
int
pf_vector_finite(pf_vector_t a)
{
	int i;
...
// Print a vector
void
pf_vector_fprintf(pf_vector_t a, FILE *file, const char *fmt)
{
	int i;
...
pf_vector_t
pf_vector_add(pf_vector_t a, pf_vector_t b)
{
	pf_vector_t c;
...
pf_vector_t
pf_vector_sub(pf_vector_t a, pf_vector_t b)
{
	pf_vector_t c;
...
pf_vector_t
pf_vector_coord_add(pf_vector_t a, pf_vector_t b)
{
	pf_vector_t c;
...
pf_vector_t
pf_vector_coord_sub(pf_vector_t a, pf_vector_t b)
{
	pf_vector_t c;
...
// Check for NAN or INF in any component
int
pf_matrix_finite(pf_matrix_t *a)
{
	int i, j;
...
// Print a matrix
void
pf_matrix_fprintf(pf_matrix_t *a, FILE *file, const char *fmt)
{
	int i, j;
...
void
pf_matrix_unitary(pf_matrix_t *r, pf_matrix_t *d, pf_matrix_t *a)
{
	int i, j;
	/*
  gsl_matrix *aa;
