...
/***************************************************************************
 *  pf_pdf.c: Useful pdf functions
 *
 *  Created: Thu May 24 18:41:18 2012
...
pf_pdf_gaussian_t *
pf_pdf_gaussian_alloc(pf_vector_t *x, pf_matrix_t *cx)
{
	pf_matrix_t        cd;
...
// Destroy the pdf
void
pf_pdf_gaussian_free(pf_pdf_gaussian_t *pdf)
{
...
pf_vector_t
pf_pdf_gaussian_sample(pf_pdf_gaussian_t *pdf)
{
	int         i, j;
	pf_vector_t r;
	pf_vector_t x;
