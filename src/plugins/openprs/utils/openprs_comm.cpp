...
void
multicast_message_string_socket(int socket, unsigned int nb_recs, Symbol *recs, PString message);
}
...
OpenPRSComm::start_recv()
{
	sd_mp_socket_.async_read_some(boost::asio::null_buffers(),
	                              boost::bind(&OpenPRSComm::handle_recv,
	                                          this,
