...
#ifndef _PLUGINS_OPENPRS_OPENPRS_THREAD_H_
#define _PLUGINS_OPENPRS_OPENPRS_THREAD_H_
...
class OpenPRSThread : public fawkes::Thread,
...
private: // methods
	...
	bool                                    server_alive();
	void check_deadline(boost::asio::deadline_timer &deadline, boost::asio::ip::tcp::socket &socket);
