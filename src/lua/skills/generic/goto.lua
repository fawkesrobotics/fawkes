...
function check_navgraph(self) return self.fsm.vars.place ~= nil and not navgraph end

fsm:define_states{
    export_to = _M,
    closure = {
        navgraph = navgraph,
        check_navgraph = check_navgraph,
    ...
    if self.fsm.vars.target_valid then
        ...
        if rel_pos.x <= 20 or rel_pos.y <= 20 then
            ...
            print_error("GOTO ERROR!!!!!!!!!! place: " .. self.fsm.vars.place ..
                            " f_x: " .. self.fsm.vars.x .. " f_y: " ..
                            self.fsm.vars.y .. " f_ori: " .. self.fsm.vars.ori ..
                            " t_x: " .. rel_pos.x .. " t_y: " .. rel_pos.y ..
                            " t_ori: " .. rel_pos.ori)
        end
