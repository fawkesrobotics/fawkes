...
-- Transitions
fsm:add_transitions{
   {"DECIDE_MODE", "FAILED", precond="not katanaarm:has_writer()", desc="no writer"},
   ...
   {"DECIDE_MODE", "VELOCITY", precond="vars.velocity ~= nil", desc="max velocity"},
   {"DECIDE_MODE", "GOTO", precond="vars.x ~= nil and vars.y ~= nil and vars.z ~= nil", desc="goto parms"},
   {"DECIDE_MODE", "GOTO_OBJECT", precond="vars.object ~= nil", desc="goto obj params"},
   {"DECIDE_MODE", "PLANNERPARAMS", precond="vars.plannerparams ~= nil", desc="planner params"},
   {"DECIDE_MODE", "STOP", precond="vars.stop"},
   {"DECIDE_MODE", "PARK", precond="vars.park"},
   {"DECIDE_MODE", "GRIPPER", precond="vars.gripper"},
   {"DECIDE_MODE", "MOVE", precond="vars.move and vars.nr and (vars.enc or vars.angle)"},
