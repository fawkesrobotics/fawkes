...
-- Transitions
fsm:add_transitions{
   {"DECIDE_MODE", "FAILED", precond_only="not katanaarm:has_writer()", desc="no writer"},
   {"DECIDE_MODE", "TURNONOFF", precond_only="vars.enable ~= nil", desc="enable parm"},
   {"DECIDE_MODE", "CALIBRATE", precond_only="vars.calibrate", desc="calib parm"},
   {"DECIDE_MODE", "VELOCITY", precond_only="vars.velocity ~= nil", desc="max velocity"},
   {"DECIDE_MODE", "GOTO", precond_only="vars.x ~= nil and vars.y ~= nil and vars.z ~= nil", desc="goto parms"},
   {"DECIDE_MODE", "GOTO_OBJECT", precond_only="vars.object ~= nil", desc="goto obj params"},
   {"DECIDE_MODE", "PLANNERPARAMS", precond_only="vars.plannerparams ~= nil", desc="planner params"},
