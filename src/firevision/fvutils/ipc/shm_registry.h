...
#define FIREVISION_SHM_IMAGE_GEEGAW_RAW                 40
#define FIREVISION_SHM_IMAGE_GEEGAW_PROCESSED           41
#define FIREVISION_SHM_IMAGE_CANNIKIN_RAW               42
#define FIREVISION_SHM_IMAGE_CANNIKIN_PROCESSED         43
