 ...
 */
void
rgb_to_yuv422planar_plainc(unsigned char *RGB, unsigned char *YUV, unsigned int width, unsigned int height)
{
  register unsigned int i = 0;
  register int y1, y2, u1, u2, v1, v2;
  register RGB_t *r1, *r2;
 ...
 */
void
bgr_to_yuv422planar_plainc(unsigned char *BGR, unsigned char *YUV, unsigned int width, unsigned int height)
{
  register unsigned int i = 0;
  register int y1, y2, u1, u2, v1, v2;
