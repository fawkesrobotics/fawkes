...
FieldLines6x4::init()
{
  ...
  push_back(field_line_t(0.2487f, 0.601f, -0.2487f, 0.601f));
  push_back(field_line_t(0.2487f, 0.601f, 0.601f, 0.2487f));
  push_back(field_line_t(0.601f, 0.2487f, 0.601f, -0.2487f));
  push_back(field_line_t(0.601f, -0.2487f, 0.2487f, -0.601f));
  push_back(field_line_t(0.2487f, -0.601f, -0.2487f, -0.601f));
  push_back(field_line_t(-0.2487f, -0.601f, -0.601f, -0.2487f));
  push_back(field_line_t(-0.601f, -0.2487f, -0.601f, 0.2487f));
  push_back(field_line_t(-0.601f, 0.2487f, -0.2487f, 0.601f));
