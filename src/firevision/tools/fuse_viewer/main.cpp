...
int main(int argc, char** argv)
{
  ...
  try
  {
    ...
    Glib::RefPtr<Gnome::Glade::Xml> refxml = Gnome::Glade::Xml::create(RESDIR"/glade/fuse_viewer/fuse_viewer.glade");
#else
    std::auto_ptr<Gnome::Glade::XmlError> error;
    Glib::RefPtr<Gnome::Glade::Xml> refxml = Gnome::Glade::Xml::create(RESDIR"/glade/fuse_viewer/fuse_viewer.glade", "", "", error);
    if (error.get()) {
